...
public class Apo2 {
    public static void main(String[] args) {
        ...
        boolean found = true;
        String[] isBeautiful = new String[variabl];
        String[] notBeautiful = new String[variabl];
        sc.nextLine();
        for(int i=0; i<variabl; i++) {
            isBeautiful[i]= sc.nextLine();
        }
        int p=1;
        for(int j=0;j<variabl;j++) {
            char[] eachL= isBeautiful[j].toCharArray();
            found=true;
            if(eachL.length!=1) {
